...
{ 
    ...
    printf("\n********* DiAie-Hellman Key Exchange Algorithm **********\n\n"); 
    ...
    if (ka == kb) 
    { 
        printf("\nDiAie-Hellman Key Exchange successful. Both parties share the same 
key.\n"); 
    } 
    else 
    { 
...
## Output:
<img width="1036" height="634" alt="image" src="https://github.com/user-attachments/assets/c497b1c5-30bf-40c0-b671-3898305336ce" />
